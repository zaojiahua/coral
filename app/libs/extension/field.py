...
from app.libs.extension.validators import DictValidatorMixin, OwnerDateTimeValidatorMixin, \
    BaseCollectionTypeValidatorMixin, FloatValidatorMixin
...
class OwnerList(BaseCollectionTypeValidatorMixin, List):
    ...
    def _remove(self):
        action = self._options.get("on_delete", True)
...
class OwnerFloatField(FloatValidatorMixin, fields.BaseField):
    _directly_redis_helpers = ('setex', 'setnx', 'getset', 'expire', 'ttl',)
