...
from app.v1.Cuttle.basic.setting import icon_threshold_camera, icon_rate, CLICK_TIME
        ...
        if self.kwargs.get('start_method', 1) != 6:
            ...
            with Complex_Center(**self.kwargs) as ocr_obj:
                ...
                executer.submit(self.delay_exec,
                                ocr_obj.point if self.kwargs.get('start_method') != 7 else ocr_obj.double_click,
                                is_init=True) \
