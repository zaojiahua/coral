...
from app.v1.Cuttle.basic.basic_views import TestOcrClass, TestIconClass, TestIconPositionClass, test_position_fixed
...
basic.add_url_rule('/icon_test_position_fixed/', view_func=test_position_fixed,methods=["POST"])
